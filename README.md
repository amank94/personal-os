...
**Requirements**: Python 3.10 or later, pip package manager
...
The setup will ask questions about your goals and create your personalized workspace.
...
- 🎯 **LLM-Powered Setup** - Conversational onboarding generates personalized GOALS.md
